...
func (g *game) Draw(screen *ebiten.Image) {
	...
	vector.StrokeLine(screen, 0, 0, mouse.X, mouse.Y, 4, color.RGBA{200, 200, 200, 255}, true)
	vector.StrokeLine(screen, 0, 0, center.X, center.Y, 4, color.RGBA{200, 200, 200, 255}, true)
