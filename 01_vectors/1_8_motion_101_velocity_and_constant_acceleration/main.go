...
//
// Port of Example 1.8 from "The Nature of Code" by Daniel Shiffman,
...
func newMover() *mover {
	return &mover{
		...
		acceleration: p5math.NewVector(-0.001, 0.01),
		topSpeed:     10,
	}
}
...
func main() {
	...
	ebiten.SetWindowTitle("Motion 101 (Velocity and Constant Acceleration)")
