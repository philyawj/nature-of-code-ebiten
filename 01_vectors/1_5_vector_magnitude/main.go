...
func (g *game) Draw(screen *ebiten.Image) {
	...
	vector.StrokeLine(screen, center.X, center.Y, center.X+mouse.X, center.Y+mouse.Y, 2, color.Black, true)

	mag := mouse.Mag()
	vector.DrawFilledRect(screen, 10, 10, mag, 10, color.Black, false)
